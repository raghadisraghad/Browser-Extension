import { getById, registerUser, loginUser, getAllFavorites, populateWebsiteTable, sendVerificationCode } from './db.js';
        ...
        if (signUpButton && signUpForm) {
            ...
            signUpFormElement.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if(await getById(signEmail)) 
                        feedbackMessage.textContent = 'Email already in use. Please try again.';
                    else {
...
const passwordInput3 = document.getElementById('login-password');
